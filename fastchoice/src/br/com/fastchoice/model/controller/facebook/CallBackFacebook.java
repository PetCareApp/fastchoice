package br.com.fastchoice.model.controller.facebook;
...
public class CallBackFacebook extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            redirectURLbuffer.replace(index, redirectURLbuffer.length(), "").append("/callBackFacebook");
            ...
            if(null!=accessToken) {
            	...
            	/*
            	FBUser fbUser = new FBUser(user.getId(),
            		user.getName(),
            		user.getLastName(),
            		user.getFirstName(),
    			user.getGender(),
    			...
    			*/
            	...
            	// back to fastchoice system
            	request.getSession().setAttribute("isFacebook", "yes");
